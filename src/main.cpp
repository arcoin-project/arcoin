...
uint256 hashGenesisBlock("0x49d4af92724e3b1110733e330a93d2ecddf3ab365ed9ab766b461efd5ae4051c");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // arcoin: starting difficulty is 1 / 2^12
...
{
    // arcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // arcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // arcoin: 3.5 days
static const int64 nTargetSpacing = 150; // arcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // arcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // arcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // arcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x4610bdf78f44c5d3d6fd27071447875d8d35d7c3c4f8b2c1f7f68b507e714edd");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "This is Arcoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("6b08f1943c5367983825c5db8d573f88427d564902445c7c206b47f8c74fa3f77efd5488fdf7e6248991025eb74cee45cb37978db4ff004fd8536583247f89a555") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1520565620;
        block.nBits    = 504365644;
        block.nNonce   = 885516103;

        if (fTestNet)
        {
            block.nTime    = 1520565620;
            block.nNonce   = 3360618868;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x514966991e3cc587b524752393423d626b5c7156f367b9e7d7774ea14419f088"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // arcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("arcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("arcoinMiner : ProcessBlock, block not accepted");
    }
